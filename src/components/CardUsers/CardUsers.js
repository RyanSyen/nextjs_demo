...
// const SWMIcon = require("react-swm-icon-pack");
...
const StyledAvatar = ({ active }) => {
  // const StyledAvatar = ({ active, avatar }) => {
  // console.log(imgDefaultAvatar);
  return (
    <StyledBadge
      overlap="circular"
      anchorOrigin={{
...
const CardUsers = (props) => {
  ...
  return (
    ...
    >
      <CardHeader
        avatar={
          <StyledAvatar active={info.status === 1} />
